...
const Checkout = () => {
  ...
  const deliveryFee = cartTotal > 50 ? 0 : 50;
  ...
  // populate address form user's defalut address
  ...
  useState(() => {
    if (user?.addresses?.length) {
      ...
      setAddress({
        _id: defalutAddr._id,
        label: defalutAddr.label,
        address: defalutAddr.address,
        city: defalutAddr?.city,
        state: defalutAddr?.state,
        zip: defalutAddr?.zip,
        isDefault: defalutAddr?.isDefault,
        lat: defalutAddr?.lat,
        lng: 0,
      });
    }
    ...
    return (
      <div className=" min-h-screen  bg-app-cream flex-center">
        <div className=" text-center">
          ...
          <p
            className=" text-sm text-shadow-app-text-light mb-4
        "
          >
            ...
            <div className=" space-y-2 text-sm">
              <div className=" flex justify-between">
               ...
               <div className=" flex justify-between">
                ...
                <span>
                  { deliveryFee === 0 ? <span className=" text-app-success ">Free</span> : `${currency}
