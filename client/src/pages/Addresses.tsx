      ...
      <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
           ...
           <div className=" flex items-center justify-between mb-8">
            <h1 className=" text-2xl font-semibold text-app-green">My Addresses</h1>
                 ...
                 ><PlusIcon  className=" size-4"/>Add Address</button>
           </div>
           ...
           {loading ? (
            ...
            <div className=" text-center py-16">
              <MapPinIcon className=" size-16 font-semibold text-app-border mx-auto mb-4" />
              <h2 className=" text-lg font-semibold text-app-green mb-2">No addressed saved</h2>
