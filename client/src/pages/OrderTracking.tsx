...
import { dummyAdminDashboardData, dummyDashboardOrdersData } from "../assets/assets";
...
const OrderTracking = () => {
  ...
  const currency = import.meta.env.VITE_CURRENCY_SYMBOM || "$"
        ...
        {/* order id  data , status */}
         <div className=" flex items-center justify-between mb-8 ">
          <div>
            ...
            <p className=" text-sm text-app-text-light mt-1">Place on {new Date(order!.createdAt).toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"})}</p>
          </div>
          <span
           className={` px-4 p-1.5 text-sm font-semibold rounded-full ${order!.status === "Delivered" ? " bg-green-100 text-green-700" : order!.status === 'Cancelled' ? " bg-red-100 text-red-700" : " bg-app-orange/10 text-app-orange"}`}
          >
            {order!.status}
          </span>
         ...
         <div className=" grid lg:grid-cols-3 gap-6">
            ...
            <div className=" space-y-5">
              ...
              <div className=" bg-white rounded-2xl p-5">
                <h3 className=" text-sm font-semibold text-app-green mb-3 flex items-center gap-2"><MapPinIcon className=" size-4"/> Delivery Address</h3>
              ...
              <div  className=" bg-white rounded-2xl p-5">
                ...
                <div className=" mt-4 p3 border-t border-app-border space-y-1.5 text-sm">
