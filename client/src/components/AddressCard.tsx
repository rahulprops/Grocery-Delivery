...
const AddressCard = ({addr,onEditHandler,setAddresses}:AddressCardProps) => {
  ...
  return (
    <div key={addr._id} className=" max-w-3xl bg-white rounded-2xl p-6 items-center  flex justify-between">
        ...
        <div className=" flex gap-4">
            ...
            <div>
                ...
                {addr.isDefault && (
                    <span
                     className=" flex-center gap-1 px-2.5 py-0.5 text-[10px] font-medium bg-app-green text-white rounded-full"
                    >
